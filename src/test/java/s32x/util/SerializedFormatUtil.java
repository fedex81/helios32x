...
//                forEach(TweakSerializedFormat::convertDvrc);
    ...
    private static void convertDmvrc(String s, Path folder) {
        ...
        s32x.vdp.MarsVdp.MarsVdpRenderContext vrcNew = new s32x.vdp.MarsVdp.MarsVdpRenderContext();
        vrcNew.screen = vrc.screen;
        vrcNew.vdpContext = convertVdpCtx(vrc.vdpContext);
        s32x.vdp.MarsVdp.DebugMarsVdpRenderContext dvrcNew = new s32x.vdp.MarsVdp.DebugMarsVdpRenderContext();
    ...
    private static void convertDvrc(String s, Path folder) {
        ...
        s32x.vdp.debug.DebugVideoRenderContext dvrcNew = new s32x.vdp.debug.DebugVideoRenderContext();
        s32x.vdp.MarsVdp.MarsVdpContext vcNew = convertVdpCtx(vc);

        dvrcNew.mdData = dvrc.mdData;
        dvrcNew.s32xData = dvrc.s32xData;
        dvrcNew.marsVdpContext = vcNew;
        dvrcNew.mdVideoMode = dvrc.mdVideoMode;
        s32x.vdp.MarsVdp.MarsVdpRenderContext vrcNew = s32x.vdp.debug.DebugVideoRenderContext.toMarsVdpRenderContext(dvrcNew);
    ...
    private static s32x.vdp.MarsVdp.MarsVdpContext convertVdpCtx(MarsVdp.MarsVdpContext vc) {
        s32x.vdp.MarsVdp.MarsVdpContext vcNew = new s32x.vdp.MarsVdp.MarsVdpContext();
        ...
        vcNew.bitmapMode = s32x.vdp.MarsVdp.BitmapMode.valueOf(vc.bitmapMode.name());
        vcNew.priority = s32x.vdp.MarsVdp.VdpPriority.valueOf(vc.priority.name());
