...
import static s32x.event.SysEventManager.SysEvent;
import static s32x.event.SysEventManager.SysEvent.INT;
import static s32x.event.SysEventManager.SysEvent.START_POLLING;
